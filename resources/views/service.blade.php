          ...
          <div class="mail-sidebar d-none d-lg-block col-md-2 pt-3 bg-white">
            <div class="menu-bar">
              <ul class="menu-items">
                ...
                <li class="active"><a href="#"><i class="ti-email"></i> Inbox</a><span class="badge badge-pill badge-success">8</span></li>
                <li><a href="#"><i class="ti-share"></i> Sent</a></li>
                <li><a href="#"><i class="ti-file"></i> Draft</a><span class="badge badge-pill badge-warning">4</span></li>
                <li><a href="#"><i class="ti-upload"></i> Outbox</a><span class="badge badge-pill badge-danger">3</span></li>
          ...
          <div class="mail-view d-none d-md-block col-md-9 col-lg-7 bg-white">
            ...
            <div class="message-body">
              <div class="sender-details">
                <img class="img-sm rounded-circle me-3" src="../../images/faces/face11.jpg" alt="">
                <div class="details">
                  <p class="msg-subject">
