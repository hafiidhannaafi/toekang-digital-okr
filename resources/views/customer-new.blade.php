...
@section('plugin-js')
    <script>
        alert(document.title = "TD - Customer")
    </script>
                                    ...
                                    <tbody class="">
                                        @foreach ($customer as $cus)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $cus->phone }}</td>
                                                <td class="text-wrap">{{ $cus->address }}</td>
                                                <td>{{ substr($cus->created_at, 0, 10) }}</td>
                                                <td>
                                                    <label
                                                        class="badge {{ $badge }} bg-light">{{ ucfirst($cus->status) }}</label>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
