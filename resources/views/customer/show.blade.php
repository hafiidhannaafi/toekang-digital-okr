...
$approval = '-';
$order = '-';
if ($customer->approval == 'declined') {
    $approval = 'Not Approved';
    $approval_badge = 'badge-danger';
} elseif ($customer->approval == 'approved') {
    $approval = 'Approved';
    $approval_badge = 'badge-success';
} elseif ($customer->approval == 'pending') {
    $approval = 'Pending';
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @foreach ($contacts as $contact)
                                        @php
                                            $whatsapp_me = str_replace(' ', '', $contact->phone);
                                            if ($i == $end - 1) {
                                                $border = '';
                                            } else {
                                        ...
                                        <div class="row my-2 {{ $border }}">
                                            <div class="col-sm-9 mb-2">
                                                <p class="mb-0 h5 text-info">{{ $contact->name }}</p>
                                                <small>{{ $contact->jabatan }}</small>
                                                <h5 class="mb-0 mt-1">{{ $contact->phone }}</h5>
                                            ...
                                            <div class="col-sm-3 align-self-center" style="padding: 0px;">
                                                ...
                                                <a href="https://api.whatsapp.com/send?phone={{ $whatsapp_me }}"
                                                    target="_blank" class="btn m-1 btn-inverse-success btn-icon">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="customer_edit" style=".form-group {margin-bottom: 0.5rem !important; }" method="POST"
                        action="/customer/{{ $customer->id }}/edit" data-validate>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Name</label>
                            <input type="text" class="form-control" id="customer_name" name="customer_name"
                                value="{{ $customer->name }}" minlength="3" required>
                        </div>
                        <div class="form-group">
                            <label for="customer_phone" class="col-form-label">Phone</label>
                            <input type="text" class="form-control" id="customer_phone" name="customer_phone"
                                value="{{ $customer->phone }}"
                                onkeyup="this.value=this.value.replace(/(\d{4})(\d+)/g, '$1 $2')" maxlength="20" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="customer_website" name="customer_website"
                                value="{{ $customer->website }}" minlength="6">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="customer_address" name="customer_address"
                                value="{{ $customer->address }}" required minlength="">
                        </div>
                        <div class="form-group">
                            <label for="customer_note" class="col-form-label">Note</label>
                            <textarea class="form-control" id="customer_note" name="customer_note" rows="2"
                                minlength="3">{{ $customer->note }}</textarea>
                        </div>
