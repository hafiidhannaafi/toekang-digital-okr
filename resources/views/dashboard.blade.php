                ...
                <div class="card tale-bg">
                    <div class="card-people mt-auto">
                        ...
                        <div class="weather-info">
                            <div class="d-flex">
                                <div>
                                    <img src="http://openweathermap.org/img/wn/{{ $image }}@4x.png" alt=""
                                        style="width: 100px">
                                </div>
                                <div>
                                    <h2 class="mb-0 font-weight-normal">{{ $temp }}</h2>
                                </div>
                                <div class="ms-2">
                                    <h4 class="location font-weight-normal">{{ $kecamatan }}</h4>
                                    <h6 class="font-weight-normal">{{ $kabupaten }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-8 text-white">
                                        <p class="mb-">Cuaca - {{ $kabupaten }} </p>
                                        <h3>{{ $temp }}</h3>
                                        <h5>{{ $cuaca }}</h5> 
                                        <p class="text-white font-weight-500 mb-0"><i class="mdi mdi-cloud"></i> {{ $wt['clouds']['all'] }}% <i class="mdi mdi-water"></i>{{ $wt['main']['humidity'] }}%</p>
                                    </div>
                                    <div class="col-4 background-icon" style="content: url(http://openweathermap.org/img/wn/{{ $image }}@4x.png);  ">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                            <div class="ml-xl-4 mt-3">
                                                <p class="card-title">Customer Reports</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 stretch-card grid-margin grid-margin-md-0">
                        <div class="card data-icon-card-primary">
                            <div class="card-body">
                                <p class="card-title text-white">Cuaca di Kantor</p>
                                <div class="row">
                                    <div class="col-8 text-white">
                                        <h3>{{ $temp }}</h3>
                                        <h5>{{ $cuaca }}</h5>
                                        <p class="text-white font-weight-500 mb-0">Banjarsari, {{ $kabupaten }} </p>
                                    </div>
                                    <div class="col-4 background-icon" style="content: url(http://openweathermap.org/img/wn/{{ $image }}@4x.png)">
                                    </div>
                                </div>
